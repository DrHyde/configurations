...
function install {
    ...
    install_symlink $HOME/bin/docker-hygiene         $CHECKOUT_DIR/../shellscripts/docker-hygiene
    ...
    install_symlink $HOME/bin/rdate                  $CHECKOUT_DIR/../perlscripts/rdate
    ...
    install_symlink $HOME/bin/weather                $CHECKOUT_DIR/../shellscripts/weather
