" the only difference from the default 'dark' theme is in
" airline_c_inactive, which shows the filename in inactive
" windows a bit brighter
"
...
let g:airline#themes#darkimproved#palette.normal = airline#themes#generate_color_map(s:airline_a_normal, s:airline_b_normal, s:airline_c_normal)

" It should be noted the above is equivalent to:
" let g:airline#themes#darkimproved#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#darkimproved#palette.normal = {
...
" applied after g:airline#themes#darkimproved#palette.normal, hence why only certain keys are
" declared.
let g:airline#themes#darkimproved#palette.normal_modified = {
...
let g:airline#themes#darkimproved#palette.insert = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)
let g:airline#themes#darkimproved#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#darkimproved#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d78700' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }

let g:airline#themes#darkimproved#palette.terminal = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)

let g:airline#themes#darkimproved#palette.replace = copy(g:airline#themes#darkimproved#palette.insert)
let g:airline#themes#darkimproved#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#darkimproved#palette.replace_modified = g:airline#themes#darkimproved#palette.insert_modified
...
let g:airline#themes#darkimproved#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
let g:airline#themes#darkimproved#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
...
let s:airline_c_inactive = [ '#cccccc' , '#303030' , 'White' , 236 , '' ]
let g:airline#themes#darkimproved#palette.inactive = airline#themes#generate_color_map(s:airline_a_inactive, s:airline_b_inactive, s:airline_c_inactive)
let g:airline#themes#darkimproved#palette.inactive_modified = {
      \ 'airline_c': [ '#875faf' , '' , 97 , '' , '' ] ,
      \ }
...
let g:airline#themes#darkimproved#palette.commandline = airline#themes#generate_color_map(s:airline_a_commandline, s:airline_b_commandline, s:airline_c_commandline)
...
let g:airline#themes#darkimproved#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#darkimproved#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
